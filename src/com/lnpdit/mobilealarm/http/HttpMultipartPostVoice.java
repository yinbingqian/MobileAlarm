...
public class HttpMultipartPostVoice extends AsyncTask<String, Integer, String> {
...
//	private ProgressDialog pd;
	...
	public HttpMultipartPostVoice(Context context, String filePath) {
...
//        HttpPost httpPost = new HttpPost("http://200.20.32.120:7799/manage/audioPost.aspx");
//        HttpPost httpPost = new HttpPost("http://200.20.30.126:7799/manage/audioPost.aspx");
        String ip_str= SOAP_UTILS.IP + "/manage/audioPost.aspx";
