...
public class MovieRecorderView extends LinearLayout implements OnErrorListener {
	...
	public MovieRecorderView(Context context, AttributeSet attrs, int defStyle) {
		...
		mRecordMaxTime = a.getInteger(
				R.styleable.MovieRecorderView_record_max_time, 30);// 默认为30
	...
	private void createRecordDir() {
		...
		try {
          ...
          String  mobileNo = sharedPreferences.getString("mobileNo", "");
			mVecordFile = File.createTempFile("recording", mobileNo + ".mp4", vecordDir);// mp4格式的录制的视频文件
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
